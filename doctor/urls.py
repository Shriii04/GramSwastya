...
from .views import patient_list, fill_report, index,recorded_audio,join_room,videocall

urlpatterns = [
    path('', index,name='index'),
    path('login', login, name='login'),
    path('doctorlist', doctor_list, name='doctor_list'),
    ...
    path('fill_report/', fill_report, name='fill_report'),
    path('enter/',recorded_audio,name='enter'),
    path('meeting/',videocall, name='meeting'),
    path('joinroom/',join_room, name='join_room'),
